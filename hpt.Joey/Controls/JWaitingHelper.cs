...
namespace HPT.Joey.Lib.Controls
{
    public class JWaitingHelper
    {
        ...
        {
            _waitingForm.MessageInfo = _inforMessage;
        }

        //操作进行完毕后关闭进度条窗体
        private void _backgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            if (_waitingForm.Visible == true)
            {
                _waitingForm.Close();
            }
        ...
        /// </example></para>
        /// </summary>
        public Action<Action<string>> BackgroundWork { get; set; }
