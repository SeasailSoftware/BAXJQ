...
namespace HPT.Joey.Lib.Controls
{
    ...
    */
    [ToolboxBitmap(typeof(JLoading))]
    public class JLoading : System.Windows.Forms.Control
    {
        ...
        public JLoading(int Alpha, bool IsShowLoadingImage)
        {
            ...
            if (IsShowLoadingImage)
            {
                ...
                pictureBox_Loading.Image = Properties.Resources.jloading;
