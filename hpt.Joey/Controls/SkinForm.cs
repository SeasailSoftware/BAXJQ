...
namespace HPT.Joey.Lib.Controls
{
    ...
    {
        //控件层
        private BaseForm Main;
        //带参构造
        public SkinForm(BaseForm main) {
            //将控制层传值过来
            this.Main = main;
            InitializeComponent();
            //置顶窗体
        ...
        public void SetBits() {
            ...
            ImageDrawRect.DrawRect(g, HPT.Joey.Lib.Properties.Resources.main_light_bkg_top123, ClientRectangle, Rectangle.FromLTRB(_BacklightLTRB.X, _BacklightLTRB.Y, _BacklightLTRB.Width, _BacklightLTRB.Height), 1, 1);
