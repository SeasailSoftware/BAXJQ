...
namespace HPT.Joey.Lib.Utils
{
    class HPTEncrytion
    {
        ...
        #region 加密单个字节
        public static byte Encrytion(byte hex)//数据加密
        {
            byte i = 0;
            byte password = 0;
        ...
        #region 加密数组
        public static byte[] Encrytion(byte[] arr)
        {
            if (arr == null)
            {
                return null;
        ...
        #region 解密单个字节
        public static byte Decryption(byte password)//数据解密 
        {
            byte hex = 0;
        ...
        #region 解密数组
        public static byte[] Decryption(byte[] arr)
        {
