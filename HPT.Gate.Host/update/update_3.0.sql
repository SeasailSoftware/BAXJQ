...
BEGIN
SET NOCOUNT ON;
	Declare @BeginDate varchar(30),@EndDate varchar(30),@RecDate varchar(20)
...
if Not exists (select * from sysobjects where id = object_id(N'[dbo].[CardType]') and OBJECTPROPERTY(id, N'IsUserTable') = 1) 
Begin
...
Insert CardType(TypeId,TypeName,CardNoLength) values(1,'IC/ID卡',4)
Insert CardType(TypeId,TypeName,CardNoLength) values(2,'身份证序列号',8)
Insert CardType(TypeId,TypeName,CardNoLength) values(3,'身份证号码',9)
