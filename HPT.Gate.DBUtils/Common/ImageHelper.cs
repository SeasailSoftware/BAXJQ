    ...
    public static class ImageHelper
    {
        ...
        public static byte[] GetByteImage(Image img)
        {
            ...
            if (!img.Equals(null))
            {
                ...
                var bmdat = bmp.LockBits(new Rectangle(Point.Empty, bmp.Size), ImageLockMode.ReadOnly, PixelFormat.Format16bppRgb565);

                bt = new byte[bmdat.Stride * bmdat.Height];

                Marshal.Copy(bmdat.Scan0, bt, 0, bt.Length);
        ...
        public static Bitmap ArrayToImage(byte[] arr)
        {
