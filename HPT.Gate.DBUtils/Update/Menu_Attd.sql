...
Insert Menus(MenuId,MenuName,MenuText,ParMenuId,EnableFlag) values(3,	'EBG_Data',	'数据同步服务',	0,	1)
Insert Menus(MenuId,MenuName,MenuText,ParMenuId,EnableFlag) values(31,	'BTI_LedSettings',	'Led同步卡设置',	3,	1)
Insert Menus(MenuId,MenuName,MenuText,ParMenuId,EnableFlag) values(32,	'BTI_Camera',	'摄像头设置',	3,	1)
Insert Menus(MenuId,MenuName,MenuText,ParMenuId,EnableFlag) values(33,	'BTI_Collect',	'数据采集',	3,	1)
Insert Menus(MenuId,MenuName,MenuText,ParMenuId,EnableFlag) values(34,	'BTI_Monitor',	'实时监控',	3,	1)
