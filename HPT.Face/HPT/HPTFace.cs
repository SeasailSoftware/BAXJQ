...
using HPT.Face.HPT.Request;
using HPT.Face.HPT.Response;
...
namespace HPT.Face.HPT
{
    public class HPTFace : HFace
    {
        ...
        public bool SetNetInfo(string ip, string pass, int isDHCPMod, string newIp, string gateway, string subNetMark, string dns, out string msg)
        {
            ...
            HPTRequestSetNetInfo requestSetNetInfo = new HPTRequestSetNetInfo()
            {
                Pass = pass,
                IsDHCPMod = isDHCPMod,
                IP = newIp,
            ...
            HPTResultInfo<HPTResponseSetNetInfo> result = GetResult<HPTResponseSetNetInfo>(response);
            msg = result.Msg;
        ...
        public bool Restart(string ip, string pass, out string msg)
        {
            ...
            HPTResultInfo<string> result = GetResult<string>(response);
            msg = result.Data;
            return result.Result == 1 && result.Success;
        }
        #endregion
        ...
        public bool SetPassword(string ip, string oldPass, string newPass, out string msg)
        {
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("content-type", "application/x-www-form-urlencoded");
            HPTRequestSetPassword setPassword = new HPTRequestSetPassword() { OldPass = oldPass, NewPass = newPass };
        ...
        public bool ChangeLogo(string ip, string pass, Image image, out string msg)
        {
            ...
            request.AddHeader("cache-control", "no-cache");
            request.AddHeader("content-type", "application/x-www-form-urlencoded");
            HPTRequestChangeLogo changeLogo = new HPTRequestChangeLogo() { Pass = pass, Logo = image };
            ...
            string ttsModStrangerContent, int relayRate, int lightPattern, out string msg)
        {
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("content-type", "application/x-www-form-urlencoded");
            HPTRequestSetConfig setConfig = new HPTRequestSetConfig()
            {
                Pass = pass,
                Data = new HPTConfig()
                {
            ...
            try
            {
                ...
                HPTResultInfo<HPTConfig> result = GetResult<HPTConfig>(response);
                msg = result.Msg;
                return result.Result == 1 && result.Success;
        ...
        #region 查询人员信息
        public bool FindPersons(string ip, string pass, out List<HPTPerson> persons, string personId = "-1")
        {
            ...
            HPTResultInfo<List<HPTPerson>> result = GetResult<List<HPTPerson>>(response);
            persons = new List<HPTPerson>();
            if (result.Result == 1)
            {
                if (result.Data != null)
        ...
        public bool CreatePerson(string ip, string password, string id, string idCardNum, string name, out string msg)
        {
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("content-type", "application/x-www-form-urlencoded");
            HPTRequestPerson requestPerson = new HPTRequestPerson() { Pass = password, Person = new HPTPerson() { Id = id, IdcardNum = idCardNum, Name = name } };
            ...
            HPTResultInfo<HPTPerson> result = GetResult<HPTPerson>(response);
            msg = result.Msg;
            return result.Result == 1 && result.Success;
        }
        #endregion
        ...
        public bool DeletePerson(string ip, string password, string id, out string msg)
        {
            ...
            HPTResultInfo<HPTResponseDeletePerson> result = GetResult<HPTResponseDeletePerson>(response);
            msg = result.Msg;
            return result.Result == 1 && result.Success;
        }
        #endregion
        ...
        public bool CreatePasstime(string ip, string password, string personId, string passtime, out string msg)
        {
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("content-type", "application/x-www-form-urlencoded");
            HPTRequestPasstime reqPasstime = new HPTRequestPasstime()
            {
                Pass = password,
                Passtime = new HPTPassTime()
                {
                    personId = personId,
                    passtime = passtime
                }
        ...
        #region 查询记录
        public List<HPTRecord> FindRecords(string ip, string password, string personId, int length, int index, string startTime, string endTime, out string msg)
        {
            var client = new RestClient($@"http://{ip}:{Port}/findRecords ");
            var request = new RestRequest(Method.POST);
            request.AddHeader("content-type", "application/x-www-form-urlencoded");
            HPTRequestFindRecords findRecords = new HPTRequestFindRecords()
            {
                Pass = password,
                PersonId = personId,
                PageSize = length,
            ...
            HPTResultInfo<HPTResponseRecords> result = GetResult<HPTResponseRecords>(response);
            msg = result.Msg;
            List<HPTRecord> records = new List<HPTRecord>();
        ...
        public  bool CreateFace(string iP, string pass, string personId, string faceId, Image face, out string msg)
        {
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("content-type", "application/x-www-form-urlencoded");
            HPTRequestFace faceAdd = new HPTRequestFace() { Pass = pass, PersonId = personId, FaceId = faceId, FaceImage = face };
        ...
        public bool UpdateFace(string iP, string pass, string personId, string faceId, Image face, out string msg)
        {
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("content-type", "application/x-www-form-urlencoded");
            HPTRequestFace faceUpdate = new HPTRequestFace() { Pass = pass, PersonId = personId, FaceId = faceId, FaceImage = face };
        ...
        #region 查询人脸
        public List<HPTFaceData> FindFaces(string iP, string pass, string personId, out string msg)
        {
            ...
            HPTResultInfo<List<HPTFaceData>> result = GetResult<List<HPTFaceData>>(response);
            msg = result.Msg;
            if (result.Result == 1)
            {
                if (result.Success)
        ...
        private HPTResultInfo<T> GetResult<T>(IRestResponse response) where T : class
        {

            if (response.StatusCode == HttpStatusCode.NotFound)
            {
                HPTResultInfo<T> result = new HPTResultInfo<T>();
        ...
        private HPTResultInfo<T> Deserialize<T>(IRestResponse response) where T : class
        {
            ...
            try
            {
                ...
                {
                    return JsonConvert.DeserializeObject(sr.ReadToEnd(), typeof(HPTResultInfo<T>), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore }) as HPTResultInfo<T>;
                }
            }
            catch (Exception ex)
            {
        ...
        public bool UpdateEmp(string ip, string password, string empCode, string empName, string endDate, Image photo, out string msg)
        {
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("content-type", "application/x-www-form-urlencoded");
            HPTRequestCreateEmp create = new HPTRequestCreateEmp()
            {
                pass = password,
                person = new HPTPerson() { Id = empCode, Name = empName, IdcardNum = empCode },
                passtime = new HPTPassTime() { personId = empCode, passtime = "00:00:00,23:59:59" },
                time = "",
                imgBase64First =FaceUtil.ImageToBase64String(photo),
                imgBase64Second = "",
                imgBase64Third =""
            };
            ...
            if (persons.Count == 0)
                ...
                return UpdatePerson(ip, password, empCode, "", empName, out msg) && ClearFaces(ip, password, empCode, out msg)
                    && CreateFace(ip, password, empCode, empCode, photo, out msg);
                    */
        }
