...
namespace hpt.gate.DbTools.Service
{
    public class AttendService
    {
        ...
        /// <param name="id"></param>
        public static void InsertShiftOfEmp(int empId, string beginDate, string endDate, int type, int id, OleDbHelper dbHelper)
        {
            ...
            for (DateTime d = dtBegin; d <= dtEnd; d = d.AddDays(1))
            {
                ...
                {
                    case 0:
                        AttendCycle attCycle = AttendService.GetAttendCycleById(id);
        ...
        private static void InsertShiftOfEmp(int empId, DateTime d, int id, OleDbHelper dbHelper)
        {
        ...
        public static List<EmpInfo> GetAttendProcEmpList(int deptId, int deptType, string empCode, string empName)
        {
            ...
            using (DBHelper dbHelper = DBHelperFactory.CreateDBHelper())
            {
                DbCommand cmd = dbHelper.GetStoredProcCommond("GetAttendProcEmpList");
                dbHelper.AddInParameter(cmd, "@DeptId", DbType.Int32, deptId);
        ...
        public static DataTable GetOriginalRecord(string beginDate, string endDate, int deptId, int deptType, string empCode, string empName)
        {
            using (DBHelper dbHelper = DBHelperFactory.CreateDBHelper())
            {
                DbCommand cmd = dbHelper.GetStoredProcCommond("GetOriginalRecord");
                dbHelper.AddInParameter(cmd, "@BeginDate", DbType.String, beginDate);
                dbHelper.AddInParameter(cmd, "@EndDate", DbType.String, endDate);
                dbHelper.AddInParameter(cmd, "@DeptId", DbType.Int32, deptId);
                dbHelper.AddInParameter(cmd, "@DeptType", DbType.Int32, deptType);
        ...
        public static DataTable GetAttendDetail(string beginDate, string endDate, int deptId, int deptType, string empCode, string empName)
        {
            using (DBHelper dbHelper = DBHelperFactory.CreateDBHelper())
            {
                DbCommand cmd = dbHelper.GetStoredProcCommond("ReportOfAttendDetail");
                dbHelper.AddInParameter(cmd, "@BeginDate", DbType.String, beginDate);
                dbHelper.AddInParameter(cmd, "@EndDate", DbType.String, endDate);
                dbHelper.AddInParameter(cmd, "@DeptId", DbType.Int32, deptId);
                dbHelper.AddInParameter(cmd, "@DeptType", DbType.Int32, deptType);
        ...
        /// <param name="endDate"></param>
        /// <param name="dbHelper"></param>
        public static void CreateAttendData(EmpInfo emp, string beginDate, string endDate)
        {
            using (DBHelper dbHelper = DBHelperFactory.CreateDBHelper())
            {
                DbCommand cmd = dbHelper.GetStoredProcCommond("CreateAttendData");
                dbHelper.AddInParameter(cmd, "@EmpId", DbType.Int32, emp.EmpId);
                dbHelper.AddInParameter(cmd, "@BeginDate", DbType.String, beginDate);
                dbHelper.AddInParameter(cmd, "@EndDate", DbType.String, endDate);
                dbHelper.ExecuteNonQuery(cmd);
        ...
        /// <param name="empName"></param>
        /// <returns></returns>
        public static DataTable GetAttendSummary(string beginDate, string endDate, int deptId, int deptType, string empCode, string empName)
        {
            using (DBHelper dbHelper = DBHelperFactory.CreateDBHelper())
            {
                DbCommand cmd = dbHelper.GetStoredProcCommond("ReportOfAttendSummary");
                dbHelper.AddInParameter(cmd, "@BeginDate", DbType.String, beginDate);
                dbHelper.AddInParameter(cmd, "@EndDate", DbType.String, endDate);
                dbHelper.AddInParameter(cmd, "@DeptId", DbType.Int32, deptId);
                dbHelper.AddInParameter(cmd, "@DeptType", DbType.Int32, deptType);
        ...
        public static void InsertAttendDetail(AttdDetail attendDetail)
        {
            using (DBHelper dbHelper = DBHelperFactory.CreateDBHelper())
            {
                ...
                sql += "INSERT INTO [AttendDetail]([EmpId],[RecDate],[BeginTime1],[EndTime1] ,[BeginTime2] ,[EndTime2],[BeginTime3],[EndTime3],[Sid],[Sname],[Late],[LeaveEarly],[Absent],[Vacation],[Ot],[WorkHour])";
