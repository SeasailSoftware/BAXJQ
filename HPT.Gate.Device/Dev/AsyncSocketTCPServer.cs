...
namespace HPT.Gate.Device.Dev
{
    ...
    public class AsyncSocketTCPServer : IDisposable
    {
        ...
        public static int DefaultListrnPort { get; set; }
        ...
        private static AsyncSocketTCPServer instance;
        private static readonly object lockHelper = new object();

        public static AsyncSocketTCPServer Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (lockHelper)
                    {
                        if (instance == null)
                        {
                            instance = new AsyncSocketTCPServer();
                        }
                    }
                }
                return instance;
        ...
        public AsyncSocketTCPServer()
            : this(IPAddress.Any, DefaultListrnPort, 1024)
        {
        }
